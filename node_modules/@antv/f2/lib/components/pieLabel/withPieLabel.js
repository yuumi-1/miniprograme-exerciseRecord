...
function findShapeByClassName(shape, point, className) {
  var targetShapes = (0, _util2.getElementsByClassName)(className, shape);
  for (var i = 0, len = targetShapes.length; i < len; i++) {
    var _shape = targetShapes[i];
    if ((0, _util2.isInBBox)(_shape.getBBox(), point)) {
      return _shape;
    }
  }
}
var _default = exports.default = function _default(View) {
  return /*#__PURE__*/function (_Component) {
    (0, _inherits2.default)(PieLabel, _Component);
    var _super = (0, _createSuper2.default)(PieLabel);
    function PieLabel(props) {
      var _this;
      (0, _classCallCheck2.default)(this, PieLabel);
      ...
      _this._handleEvent = function (ev) {
        ...
        if (typeof onClick === 'function') {
          ...
          // 点击饼图
          else if ((0, _util.isArray)(pieData) && pieData.length > 0) {
            onClick(pieData);
          }
        }
      };
    ...
    (0, _createClass2.default)(PieLabel, [{
      key: "willMount",
      ...
      value: function getLabels(props) {
        ...
        if (halves[0].length > maxCountForOneSide) {
          ...
          var _move = move(halves[1], halves[0], halves[1].length - maxCountForOneSide, center),
            _move2 = (0, _slicedToArray2.default)(_move, 2),
            right = _move2[0],
            left = _move2[1];
          halves = [left, right];
        }
