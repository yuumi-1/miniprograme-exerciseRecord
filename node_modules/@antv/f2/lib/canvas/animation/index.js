...
var _timelime = _interopRequireDefault(require("./timelime"));
var _animator2 = _interopRequireDefault(require("./animator"));
...
var Animation = /*#__PURE__*/function () {
  function Animation(canvas) {
    ...
    this.timeline = new _timelime.default();
    this.canvas = canvas;
  }
  (0, _createClass2.default)(Animation, [{
    ...
    value: function createAnimator(element, animation) {
      ...
      return new _animator2.default(element, animation);
    }
  }, {
    key: "play",
    value: function play(container, onAnimationEnd) {
      ...
      eachElement(container, function (element) {
        ...
        if (!animation) {
          if (status === _jsx.ElementStatus.ELEMENT_DELETE) {
            // element.remove(true);
